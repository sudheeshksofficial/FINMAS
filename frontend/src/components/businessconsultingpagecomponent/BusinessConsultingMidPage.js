...
import { BUSINESS_CONSULTING_PAGE_SECOND_IMAGE} from "../../ConstantsImage";
...
function BusinessConsultingMidPageComponent() {
    ...
    return (
        <MidDiv>
            <LeftDiv>
                <img src={BUSINESS_CONSULTING_PAGE_SECOND_IMAGE} style={{ height: 500, width: '100%'}}/>
...
export default BusinessConsultingMidPageComponent;