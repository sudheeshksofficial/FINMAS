 ...
 * @Last Modified time: 2023-05-28 11:57:28
 * @Description: description
 */
import { styled } from "@mui/material";
import AgricultureLoanFirstImageComponent from "./agricultureloanpagecomponent/AgricultureLoanFirstImageComponent";
import AgricultureLoanFormComponent from "./agricultureloanpagecomponent/AgricultureLoanFormComponent";
...
function AgricultureLoanPage(props){
    return (
        <Desktop11 className={props.className}>
            <TitleBar1/>
            <TitleBar2/>
            <AgricultureLoanFirstImageComponent/>
            <AgricultureLoanFormComponent/>
            <AboutUsFooter/>
        </Desktop11>
    );
}
