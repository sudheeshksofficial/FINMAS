...
import { WEALTH_PAGE_SECOND_IMAGE } from "../../ConstantsImage";
...
function WealthMidPageComponent() {
    ...
    return (
        <MidDiv>
            <LeftDiv>
                <img src={WEALTH_PAGE_SECOND_IMAGE} style={{ height: 500, width: '100%'}}/>
...
export default WealthMidPageComponent;