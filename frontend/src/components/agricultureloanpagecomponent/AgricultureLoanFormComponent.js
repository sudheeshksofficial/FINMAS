...
import { AGRICULTURE_LOAN_URL, AUTO_LOAN_URL, BUSINESS_LOAN_URL, CREDIT_CARD_URL, EDUCATION_LOAN_URL, GOLD_LOAN_URL, HOME_LOAN_URL, INSURANCE_URL, MORTGAGE_LOAN_URL, PERSONAL_LOAN_URL, PRODUCTS_URL, PROPERTY_LOAN_URL, TRADING_URL } from '../../Constants_Personal_URLS';
...
function AgricultureLoanFormComponent() {
...
export default AgricultureLoanFormComponent;