...
import { FINANCIAL_ADVISOR_PAGE_SECOND_IMAGE } from "../../ConstantsImage";
...
function FinancialAdvisorMidPageComponent() {
    ...
    return (
        <MidDiv>
            <LeftDiv>
                <img src={FINANCIAL_ADVISOR_PAGE_SECOND_IMAGE} style={{ height: 500, width: '100%'}}/>
...
export default FinancialAdvisorMidPageComponent;