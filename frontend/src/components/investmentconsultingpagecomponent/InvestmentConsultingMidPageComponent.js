...
import { FINANCIAL_ADVISOR_PAGE_SECOND_IMAGE, INVESTMENT_CONSULTING_PAGE_SECOND_IMAGE } from "../../ConstantsImage";
...
function InvestmentConsultingMidPageComponent() {
    ...
    return (
        <MidDiv>
            <LeftDiv>
                <img src={INVESTMENT_CONSULTING_PAGE_SECOND_IMAGE} style={{ height: 500, width: '100%'}}/>
...
export default InvestmentConsultingMidPageComponent;