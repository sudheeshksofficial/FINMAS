...
import { STOCKS_PAGE_SECOND_IMAGE } from "../../ConstantsImage";
...
function StocksMidPageComponent() {
    ...
    return (
        <MidDiv>
            <LeftDiv>
                <img src={STOCKS_PAGE_SECOND_IMAGE} style={{ height: 500, width: '100%'}}/>
...
export default StocksMidPageComponent;