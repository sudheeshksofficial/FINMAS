 ...
 * @Last Modified time: 2023-05-28 11:55:43
 * @Description: description
 */
import { styled } from "@mui/material";
import AutoLoanFirstImageComponent from "./autoloanpagecomponent/AutoLoanFirstImageComponent";
import AutoLoanFormComponent from "./autoloanpagecomponent/AutoLoanFormComponent";
...
function AutoLoanPage(props){
    return (
        <Desktop11 className={props.className}>
            <TitleBar1/>
            <TitleBar2/>
            <AutoLoanFirstImageComponent/>
            <AutoLoanFormComponent/>
            <AboutUsFooter/>
        </Desktop11>
    );
}
