...
import { FINANCIAL_ADVISOR_PAGE_SECOND_IMAGE, NET_WORTH_PAGE_SECOND_IMAGE } from "../../ConstantsImage";
...
function NetWorthMidPageComponent() {
    ...
    return (
        <MidDiv>
            <LeftDiv>
                <img src={NET_WORTH_PAGE_SECOND_IMAGE} style={{ height: 500, width: '100%'}}/>
...
export default NetWorthMidPageComponent;