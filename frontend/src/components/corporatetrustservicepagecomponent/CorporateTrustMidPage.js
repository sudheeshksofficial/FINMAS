...
import { CORPORATE_TRUST_PAGE_SECOND_IMAGE, FINANCIAL_ADVISOR_PAGE_SECOND_IMAGE } from "../../ConstantsImage";
...
function CorporateTrustMidPageComponent() {
    ...
    return (
        <MidDiv>
            <LeftDiv>
                <img src={CORPORATE_TRUST_PAGE_SECOND_IMAGE} style={{ height: 500, width: '100%'}}/>
...
export default CorporateTrustMidPageComponent;